      ...
      <div className="my-5 relative m-8">
        ...
        <ul className="list-none m-0 p-0">
          ...
          <li className="mb-2">
            <div className="flex items-center mb-1">
              <div className="bg-gray-500 rounded-full h-8 w-8"></div>
              <div className="flex-1 ml-4 font-medium">Août 2022 - Exposé à la 24th International Conference on Computational Statistics</div>
            </div>
            <div className="ml-12">
              Bologna, Italy.
            </div>
          ...
          <li className="mb-2">
            <div className="flex items-center mb-1">
              <div className="bg-gray-500 rounded-full h-8 w-8"></div>
              <div className="flex-1 ml-4 font-medium">Juin 2022 - Exposé à la Journée des doctorants à l’IMAG</div>
            </div>
            <div className="ml-12">
              Montpellier.
            </div>
          ...
          <li className="mb-2">
            <div className="flex items-center mb-1">
              <div className="bg-gray-500 rounded-full h-8 w-8"></div>
              <div className="flex-1 ml-4 font-medium">Mai 2022 - Exposé au 20th International Workshop in Spatial Econometrics and Statistics</div>
            </div>
            <div className="ml-12">
              Lille.
            </div>
          ...
          <li className="mb-2">
            <div className="flex items-center mb-1">
              <div className="bg-gray-500 rounded-full h-8 w-8"></div>
              <div className="flex-1 ml-4 font-medium">Mars 2022 - Séminaire des doctorant.e.s de Montpellier</div>
            </div>
            <div className="ml-12">
          ...
          <li className="mb-2">
            <div className="flex items-center mb-1">
              <div className="bg-gray-500 rounded-full h-8 w-8"></div>
              <div className="flex-1 ml-4 font-medium">Nov. 2021 - Séminaire des doctorant.e.s de Montpellier</div>
            </div>
            <div className="ml-12">
              Institut Montpelliérain Alexender Grothendieck, Montpellier.
            </div>
          ...
          <li className="mb-2">
            <div className="flex items-center mb-1">
              <div className="bg-gray-500 rounded-full h-8 w-8"></div>
              <div className="flex-1 ml-4 font-medium">Mars 2019 - Participation aux journées des doctorantes en probabilités</div>
            </div>
            <div className="ml-12">
